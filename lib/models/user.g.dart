...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'shouldChangePassword': PropertySchema(
      id: 4,
      name: r'shouldChangePassword',
      type: IsarType.bool,
    ),
...
void _userSerialize(
  ...
  writer.writeBool(offsets[4], object.shouldChangePassword);
...
User _userDeserialize(
  ...
  final object = User(
    ...
    shouldChangePassword: reader.readBool(offsets[4]),
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> shouldChangePasswordEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'shouldChangePassword',
        value: value,
      ));
    });
  }
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByShouldChangePassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'shouldChangePassword', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByShouldChangePasswordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'shouldChangePassword', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByShouldChangePassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'shouldChangePassword', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByShouldChangePasswordDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'shouldChangePassword', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByShouldChangePassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'shouldChangePassword');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, bool, QQueryOperations> shouldChangePasswordProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'shouldChangePassword');
    });
  }
