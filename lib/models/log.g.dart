...
extension LogQueryFilter on QueryBuilder<Log, Log, QFilterCondition> {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsEqualTo(
    String? value, {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'details',
        value: '',
  ...
  QueryBuilder<Log, Log, QAfterFilterCondition> detailsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'details',
        value: '',
...
extension LogQuerySortBy on QueryBuilder<Log, Log, QSortBy> {
  ...
  QueryBuilder<Log, Log, QAfterSortBy> sortByDetails() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.asc);
    });
  }

  QueryBuilder<Log, Log, QAfterSortBy> sortByDetailsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LogQuerySortThenBy on QueryBuilder<Log, Log, QSortThenBy> {
  ...
  QueryBuilder<Log, Log, QAfterSortBy> thenByDetails() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.asc);
    });
  }

  QueryBuilder<Log, Log, QAfterSortBy> thenByDetailsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'details', Sort.desc);
    });
  }
...
extension LogQueryWhereDistinct on QueryBuilder<Log, Log, QDistinct> {
  ...
  QueryBuilder<Log, Log, QDistinct> distinctByDetails(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension LogQueryProperty on QueryBuilder<Log, Log, QQueryProperty> {
  ...
  QueryBuilder<Log, String?, QQueryOperations> detailsProperty() {
    return QueryBuilder.apply(this, (query) {
