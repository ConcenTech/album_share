...
extension AlbumQueryFilter on QueryBuilder<Album, Album, QFilterCondition> {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> isActivityEnabledEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'thumbnailId',
        value: '',
  ...
  QueryBuilder<Album, Album, QAfterFilterCondition> thumbnailIdIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'thumbnailId',
        value: '',
...
extension AlbumQuerySortBy on QueryBuilder<Album, Album, QSortBy> {
  ...
  QueryBuilder<Album, Album, QAfterSortBy> sortByIsActivityEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActivityEnabled', Sort.asc);
    });
  }

  QueryBuilder<Album, Album, QAfterSortBy> sortByIsActivityEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QAfterSortBy> sortByThumbnailId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailId', Sort.asc);
    });
  }

  QueryBuilder<Album, Album, QAfterSortBy> sortByThumbnailIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AlbumQuerySortThenBy on QueryBuilder<Album, Album, QSortThenBy> {
  ...
  QueryBuilder<Album, Album, QAfterSortBy> thenByIsActivityEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActivityEnabled', Sort.asc);
    });
  }

  QueryBuilder<Album, Album, QAfterSortBy> thenByIsActivityEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isActivityEnabled', Sort.desc);
    });
  }
  ...
  QueryBuilder<Album, Album, QAfterSortBy> thenByThumbnailId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailId', Sort.asc);
    });
  }

  QueryBuilder<Album, Album, QAfterSortBy> thenByThumbnailIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thumbnailId', Sort.desc);
    });
  }
...
extension AlbumQueryWhereDistinct on QueryBuilder<Album, Album, QDistinct> {
  ...
  QueryBuilder<Album, Album, QDistinct> distinctByIsActivityEnabled() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Album, Album, QDistinct> distinctByThumbnailId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
